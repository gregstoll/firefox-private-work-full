...
command cp third_party/content_analysis_sdk/proto/content_analysis/sdk/analysis.proto toolkit/components/contentanalysis/sdk/analysis.proto
regenerate toolkit/components/contentanalysis/ analysis.proto
